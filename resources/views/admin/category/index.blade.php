                                            ...
                                            <div class="col-sm-12">
                                                <table id="default-datatable" data-plugin="DataTable" class="table table-striped dataTable" cellspacing="0" width="100%" role="grid" aria-describedby="default-datatable_info" style="width: 100%;">
                                                    ...
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="default-datatable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 122px;">Şəkil</th>
                                                    ...
                                                    @foreach($categorys as $k => $category)
                                                        @if((($k % 2) == 1))
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td>{{ $category->sira }}</td>
                                                                <td class=""><img src="/images/category/{{ $category->img }}" alt="{{ $category->title }}" class="img-thumbnail"></td>
                                                                <td>
