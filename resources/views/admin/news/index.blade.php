                                                ...
                                                <table id="default-datatable" data-plugin="DataTable"
                                                    ...
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0"
                                                            ...
                                                            style="width: 30px;">Tip
                                                        </th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-datatable" rowspan="1" colspan="1"
                                                            aria-label="Position: activate to sort column ascending"
                                                            style="width: 30px;">Slider
                                                        </th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-datatable" rowspan="1" colspan="1"
                                                            aria-label="Position: activate to sort column ascending"
                                                    ...
                                                    @foreach($news as $k => $new)
                                                        @if((($k % 2) == 1))
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td class="">{{ $new->slider == 1 ? 'yes' : 'no' }}</td>
                                                                <td class="">{{ substr($new->title, 0, 30) }}</td>
                                                                <td>{{ $new->author }}</td>
                                                                <td class=""><img src="/images/{{ $new->img }}" alt="{{ $new->title }}" class="img-thumbnail"></td>
                                                                <td>
